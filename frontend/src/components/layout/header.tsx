...
const adminNavItems = [
  ...
  { name: "Chat", href: ROUTES.CHAT, icon: MessageSquare, adminOnly: false },  { name: "Knowledge Base", href: ROUTES.RAG, icon: Database, adminOnly: true },  { name: "Profile", href: ROUTES.PROFILE, icon: UserCircle, adminOnly: false },];
