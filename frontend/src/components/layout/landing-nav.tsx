...
import Link from "next/link";import { useAuth } from "@/hooks";import { ThemeToggle } from "@/components/theme";
import { LanguageSwitcherCompact } from "@/components/language-switcher";
import { APP_NAME, ROUTES } from "@/lib/constants";import { LogOut, User } from "lucide-react";
...
export function LandingNav({ signInLabel, getStartedLabel, dashboardLabel }: LandingNavProps) {  const { user, isAuthenticated, logout } = useAuth();
  return (
