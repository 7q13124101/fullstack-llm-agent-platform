...
import { User as UserIcon, Mail, Shield, Settings, Monitor, Smartphone, Globe, Trash2, Palette, LogOut, Camera } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const avatarInputRef = useRef<HTMLInputElement>(null);  const [sessions, setSessions] = useState<Session[]>([]);
