      ...
      <div className="grid gap-4">
        ...
        <Card className="p-4 sm:p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium">fullstack_llm_agent_platform</span>
            </div>
            <div className="flex items-center justify-between text-sm">
        ...
        <Card className="p-4 sm:p-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Badge variant="outline">Next.js 15</Badge>            <Badge variant="outline">PostgreSQL</Badge>          </div>
        </Card>
        ...
        <Card className="p-4 sm:p-6">
          ...
          <div className="space-y-3">            <div className="flex items-center justify-between text-sm">
