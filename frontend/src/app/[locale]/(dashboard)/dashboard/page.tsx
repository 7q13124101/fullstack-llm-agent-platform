...
import {
  ...
  ExternalLink,
  BookOpen,  Star,
  List,} from "lucide-react";import { listCollections, getCollectionInfo } from "@/lib/rag-api";
...
export default function DashboardPage() {
  ...
  const [healthError, setHealthError] = useState(false);  const [ragStats, setRagStats] = useState<{ collections: number; vectors: number } | null>(null);
  useEffect(() => {
    ...
    checkHealth();    const loadRagStats = async () => {
      try {
    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">langgraph</p>
            <p className="text-xs text-muted-foreground">google provider</p>
          </CardContent>
        </Card>        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
