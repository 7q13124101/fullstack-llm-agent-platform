...
import {
  Bot,
  Zap,  Database,  Shield,  LayoutDashboard,
  Server,
  ArrowRight,
  ChevronRight,
  ChevronDown,
...
export default async function HomePage() {
  ...
  const techItems = [
    "Next.js 15", "React 19", "TypeScript", "Tailwind CSS", "FastAPI", "LangGraph", "SQLAlchemy", "PostgreSQL", "Docker", "Traefik", "JWT Auth", "WebSockets", "Logfire", "OpenTelemetry", "PyMuPDF", "BM25", "next-intl",
            ...
            <div className="flex gap-16">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href={ROUTES.CHAT} className="text-sm text-muted-foreground transition-colors hover:text-foreground">Chat</Link></li>                  <li><Link href={ROUTES.RAG} className="text-sm text-muted-foreground transition-colors hover:text-foreground">Knowledge Base</Link></li>                </ul>
              </div>
              <div>
                <h4 className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  { t("footerResources")}
                ...
                <ul className="space-y-2">
                  <li><a href={ `${BACKEND_URL}/docs`} className="text-sm text-muted-foreground transition-colors hover:text-foreground">API Docs</a></li>                  <li><Link href={ROUTES.LOGIN} className="text-sm text-muted-foreground transition-colors hover:text-foreground">Sign In</Link></li>                </ul>
              </div>
            </div>
          </div>
        </div>
