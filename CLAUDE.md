...
├── agents/               # AI agent wrappers + tools├── rag/                  # RAG: embeddings, vector store, ingestion, parsers
│   └── connectors/       # Sync source connectors (Google Drive, S3)├── worker/               # Background tasks (Celery/Taskiq/ARQ)
