...
from httpx import ASGITransportfrom app.api.deps import get_db_sessionfrom app.main import app
...
async def error_client(
    mock_user_service_with_errors: MagicMock,    mock_db_session,) -> AsyncClient:
    """Client with mocked services that raise errors."""
    from app.api.deps import get_user_service

    app.dependency_overrides[get_user_service] = lambda: mock_user_service_with_errors    app.dependency_overrides[get_db_session] = lambda: mock_db_session
