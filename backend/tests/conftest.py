...
from collections.abc import AsyncGeneratorfrom unittest.mock import AsyncMock
import pytest
from httpx import ASGITransport, AsyncClient

from app.main import appfrom app.core.config import settingsfrom app.api.deps import get_db_session
...
async def client(    mock_db_session,) -> AsyncGenerator[AsyncClient, None]:
    ...
    """
    # Override dependencies for testing    app.dependency_overrides[get_db_session] = lambda: mock_db_session
...
def api_key_headers() -> dict[str, str]:
    ...
    return {settings.API_KEY_HEADER: settings.API_KEY}# Note: For integration tests requiring authenticated users,
