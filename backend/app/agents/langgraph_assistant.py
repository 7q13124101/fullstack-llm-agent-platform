...
from langgraph.graph.message import add_messagesfrom langchain_google_genai import ChatGoogleGenerativeAI
from app.agents.prompts import DEFAULT_SYSTEM_PROMPTfrom app.agents.prompts import get_system_prompt_with_ragfrom app.agents.tools import get_current_datetimefrom app.agents.tools.rag_tool import search_knowledge_base_syncfrom app.core.config import settings
...
def current_datetime() -> str:
    ...
    """
    return get_current_datetime()@tool
...
ALL_TOOLS = [current_datetime]ALL_TOOLS.append(search_documents)
...
class LangGraphAssistant:
    ...
    def __init__(
        ...
        self.temperature = temperature or settings.AI_TEMPERATURE        self.system_prompt = system_prompt or get_system_prompt_with_rag()        self._graph = None
        self._checkpointer = MemorySaver()

    def _create_model(self):
        """Create the LLM model with tools bound."""        model = ChatGoogleGenerativeAI(
