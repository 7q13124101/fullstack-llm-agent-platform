...
def _get_retrieval_service() -> "BaseRetrievalService":
    ...
    from app.rag.retrieval import RetrievalService    from app.rag.vectorstore import PgVectorStore    from app.rag.embeddings import EmbeddingService

    rag_settings = settings.rag
    embedding_service = EmbeddingService(rag_settings)    vector_store = PgVectorStore(rag_settings, embedding_service)    _retrieval_service = RetrievalService(vector_store, rag_settings)
    return _retrieval_service
...
def search_knowledge_base_sync(
    ...
    try:
        ...
        raise__all__ = ["search_knowledge_base", "search_knowledge_base_sync"]