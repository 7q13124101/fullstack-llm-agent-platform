...
class EmbeddingsConfig(BaseModel):
    """Embeddings configuration. Dimension is auto-derived from model name."""    model: str = "gemini-embedding-exp-03-07"
    dim: int = 3072
...
class RerankerConfig(BaseModel):
    """Reranker configuration."""    model: str = "cross_encoder"
...
class PdfParser(BaseModel):
    """PDF parsing settings."""    method: str = "pymupdf"
...
class RAGSettings(BaseModel):
    ...
    # Embeddings
    embeddings_config: EmbeddingsConfig = Field(default_factory=EmbeddingsConfig)    # Reranker
    ...
    # Sources    gdrive_ingestion: bool = True