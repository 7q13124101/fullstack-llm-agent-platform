...
Built-in connectors:- **Google Drive** (`gdrive`) — fetches from shared Drive folders
...
- **CLI** — `uv run fullstack_llm_agent_platform rag-sync` commands
...
uv run fullstack_llm_agent_platform cmd rag-sync --connector my_source \
